				...
				<div class="col-md-9 spldishes-grids">
					...
					<div id="owl-demo" class="owl-carousel text-center agileinfo-gallery-row">
						@foreach ($dishes as $dish)
						    <a class="item g1" href="{{ route('category_dish', ['category_id'=>$dish->category_id]) }}">
							<img class="lazyOwl" src="{{ asset('/BackEndSourceFile/dish_img/')}}/{{ $dish->dish_image }}" style="height: 210px; width:210px;" title="Our latest gallery" alt=""/>
