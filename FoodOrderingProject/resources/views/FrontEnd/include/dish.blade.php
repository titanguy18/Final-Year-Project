					...
					<div class="col-xs-6 col-sm-4 product-grids">
						<div class="flip-container">
							<div class="flipper agile-products">
								<div class="front"> 
									<img src="{{ asset('/BackEndSourceFile/dish_img/')}}/{{ $dish->dish_image }}" style="width：277px; height: 182px;" class="img-responsive" alt="img">
								...
								<div class="back">
                                    ...
                                    @if ($dish->half_price==null)
                                     ...
                                     @else   
                                     <h6>Half {{ $dish->half_price }}<sup>TK</sup></h6>
                                    @endif
				...
				<section>
					<div class="modal-body">
						<div class="col-md-5 modal_body_left">
							<img src="{{ asset('/BackEndSourceFile/dish_img/')}}/{{ $dish->dish_image }}" alt=" " class="img-responsive">
						</div>
