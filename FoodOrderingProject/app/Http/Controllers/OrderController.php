...
class OrderController extends Controller
{
    ...
    return view('view_order', compact('order','customer','shipping','payment','orderDetail'));
    }
public function viewInvoice($order_id){
    ...
    return view('view_order_invoice', compact('order','customer','shipping','payment','order_details'));
}
...
$order = Order::find($order_id);
       ...
       $dompdf = new Dompdf();
      $dompdf->loadHtml(view('download_invoice', compact('order','customer','shipping','payment','order_details')));
