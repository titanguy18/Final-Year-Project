...
<!-- Coupon start here -->
 ...
 <li class="nav-item has-treeview">
      ...
      <li class="nav-item has-treeview">
            <a href="#" class="nav-link">
            <i class="nav-icon fas fa-pie-chart" aria-hidden="true"></i>
              <p>
                Analysis
                <i class="right fas fa-angle-left"></i>
              </p>
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
              <a href="{{ route('analysis') }}" class="nav-link active">
                <i class="fas fa-check-square-o nav-icon" aria-hidden="true"></i>
                  <p>View Status</p>  
                </a>
              </li>
        </ul>
