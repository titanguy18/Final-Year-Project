...
.footer-copyright 
{
   ...
   <body>
       ...
       <img src="{{asset('image/Black Blue Yellow Simple Oniversity Graduate School On Logo Templates.jpg')}}"  width="100" height="95" alt="">
    ...
    <footer class="page-footer">
        <div class="container">
         ...
         <div class="col-lg-4 col-md-4 col-sm-12">
            <h6>Address: 84B, Jalan Susur Idaman, Nusa Idaman, 79100 Nusajaya, Johor</h6>
            <h6></h6>
         </div>
         <div>
        <div class="footer-copyright text-center">© 2021 Copyright: Crown Exotic Car Dealership</div>
